...
static void HAL_FMC_MspInit(void){
  ...
  */
  ...
  /* GPIO_InitStruct */
  GPIO_InitStruct.Pin = D7_Pin|D8_Pin|D9_Pin|D10_Pin
...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOE, D7_Pin|D8_Pin|D9_Pin|D10_Pin
                          |D11_Pin|D12_Pin|NBL0_Pin|NBL1_Pin);

  HAL_GPIO_DeInit(GPIOD, D13_Pin|D14_Pin|D15_Pin|D0_Pin
                          |D1_Pin|D2_Pin|D3_Pin);

  HAL_GPIO_DeInit(GPIOG, BA0_Pin|BA1_Pin|SDCLK_Pin|SDNCAS_Pin);
